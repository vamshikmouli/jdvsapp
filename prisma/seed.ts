import { PrismaClient, ClassGroup, Gender, StudentStatus } from '@prisma/client';

const prisma = new PrismaClient();

const CLASS_SEED = [
  { id: 'prekg', name: 'Pre-KG', order: 0, room: 'G-00', group: 'PRE' as ClassGroup },
  { id: 'lkg', name: 'LKG', order: 1, room: 'G-01', group: 'PRE' as ClassGroup },
  { id: 'ukg', name: 'UKG', order: 2, room: 'G-02', group: 'PRE' as ClassGroup },
  { id: '1', name: '1st STD', order: 3, room: '101', group: 'PRIMARY' as ClassGroup },
  { id: '2', name: '2nd STD', order: 4, room: '102', group: 'PRIMARY' as ClassGroup },
  { id: '3', name: '3rd STD', order: 5, room: '103', group: 'PRIMARY' as ClassGroup },
  { id: '4', name: '4th STD', order: 6, room: '104', group: 'PRIMARY' as ClassGroup },
  { id: '5', name: '5th STD', order: 7, room: '105', group: 'PRIMARY' as ClassGroup },
  { id: '6', name: '6th STD', order: 8, room: '201', group: 'SECONDARY' as ClassGroup },
  { id: '7', name: '7th STD', order: 9, room: '202', group: 'SECONDARY' as ClassGroup },
  { id: '8', name: '8th STD', order: 10, room: '203', group: 'SECONDARY' as ClassGroup },
  { id: '9', name: '9th STD', order: 11, room: '204', group: 'SECONDARY' as ClassGroup },
  { id: '10', name: '10th STD', order: 12, room: '205', group: 'SECONDARY' as ClassGroup },
];
...
async function main() {
  ...
  for (const cls of CLASS_SEED) {
    const count = studentCount[cls.id as keyof typeof studentCount] || 3;
    ...
    for (let i = 0; i < count; i++) {
      ...
      const gender = genderHash === 0 ? Gender.F : Gender.M;
      const guardianName = `${gender === Gender.F ? 'Mrs.' : 'Mr.'} ${lastName}`;
      ...
      await prisma.student.create({
        data: {
          ...
          village: ['Karenahalli', 'Channasandra', 'Raghupati Agrahara'][hash(name) % 3],
          status: hash(name) % 11 === 0 ? StudentStatus.INACTIVE : StudentStatus.ACTIVE,
